...
- **ScrollPanel**: Универсальный компонент для списков и карточек. Использует `glScissor` для точного отсечения контента в заданных границах окна. OpenGL координаты корректно инвертированы (Y-bottom).
