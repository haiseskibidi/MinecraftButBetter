...
9.  **Shader-Based Masking (NEW)**: Универсальная система динамического "вырезания" текстур на основе 16-битной маски (`faceMask`), передаваемой в `fragment.glsl`. Используется для плавного отображения прогресса (например, обтёсывания бревен).
