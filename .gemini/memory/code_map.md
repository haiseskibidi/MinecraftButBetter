...
- **ParticleRenderer.java**: Высокопроизводительный инстанс-рендерер. Отрисовывает квадратные билборды, ориентированные на камеру. Передает параметры времени, текстурных слоев и UV-смещений в шейдеры.
