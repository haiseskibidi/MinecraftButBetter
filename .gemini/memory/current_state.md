...
- **Tactical Minimap (Radar) v1.1 (NEW)**:
  - **Fast Top-Down Sampling**: Прямой доступ к `Chunk.blockData` для мгновенного сканирования ландшафта (180x180).
  - **Radar Sonar Effect**: Визуализация радиуса шума игрока через динамические расширяющиеся волны на карте.
  - **Symmetric Status HUD**: Полоска шума вынесена под Стамину, создавая симметрию с Голодом под Здоровьем.
