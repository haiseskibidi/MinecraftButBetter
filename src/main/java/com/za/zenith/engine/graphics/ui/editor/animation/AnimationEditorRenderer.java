...
public class AnimationEditorRenderer {
    ...
    private com.za.zenith.engine.graphics.Mesh gizmoMesh;
    private com.za.zenith.engine.graphics.Mesh circleMesh;
    ...
    private void initGizmoMesh() {
        ...
        float[] neighbor = { 0, 0 };
        int[] ind = { 0, 1 };
        this.gizmoMesh = new com.za.zenith.engine.graphics.Mesh(pos, uv, norm, types, neighbor, ind);
        ...
        this.circleMesh = new com.za.zenith.engine.graphics.Mesh(cPos, cUv, cNorm, cTypes, cNeighbors, cInd);
    }
