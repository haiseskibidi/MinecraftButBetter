...
import com.za.zenith.world.inventory.RegistryInventory;
        ...
        for (GUIConfig.GroupConfig groupCfg : config.groups) {
            if (groupCfg.condition != null) {
                ...
                if (groupCfg.condition.equals("has_pouch")) {
                    ...
                    if (acc == null || !acc.getItem().hasComponent(com.za.zenith.world.items.component.BagComponent.class)) continue;
