package com.za.minecraft.engine.graphics.model.ik;
        ...
        if (distToTarget > totalLength) {
            ...
            for (int iter = 0; iter < chain.maxIterations; iter++) {
                ...
                for (int i = 0; i < n - 1; i++) {
                    ...
                    // --- APPLY CONSTRAINTS ---
                    com.za.minecraft.engine.graphics.model.ik.constraints.IKConstraint constraint = chain.constraints.get(chain.nodes.get(i));
                    if (constraint != null) {
