...
import com.za.minecraft.engine.graphics.ui.renderers.*;
...
public class UIRenderer {
    ...
    public void renderSlot(int x, int y, int size, com.za.minecraft.world.items.ItemStack stack, String placeholder, int screenWidth, int screenHeight, com.za.minecraft.engine.graphics.DynamicTextureAtlas atlas) {
        slotRenderer.renderSlot(x, y, size, stack, placeholder, screenWidth, screenHeight, atlas);
    }

    public void renderSlot(int x, int y, int size, com.za.minecraft.world.items.ItemStack stack, String placeholder, int screenWidth, int screenHeight, com.za.minecraft.engine.graphics.DynamicTextureAtlas atlas, boolean isHovered, String animId, boolean drawBackground) {
