...
public class GeneratorBlockEntity extends BlockEntity implements ITickable, IEnergyStorage {
    ...
    public void update(float deltaTime) {
        if (running) {
            if (fuel > 0) {
                ...
                fuel = 0;
                running = false;
                com.za.minecraft.utils.Logger.info("Generator at %s stopped: out of fuel", pos);
            }
        }
    }
    ...
    public void addFuel(float amount) {
        ...
        this.running = true;
        com.za.minecraft.utils.Logger.info("Generator at %s refueled. Current fuel: %.1f", pos, fuel);
    }
